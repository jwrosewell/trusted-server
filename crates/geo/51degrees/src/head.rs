...
mod tests {
    ...
    fn the_tag_matches_the_shape_the_vendor_publishes() {
        ...
        let inserts = injector.head_inserts(&context("publisher.example"));
    ...
    fn only_the_high_entropy_hints_are_delegated() {
        ...
        let tag = injector
            .head_inserts(&context("publisher.example"))
            .remove(0);
    ...
    fn nothing_is_written_when_the_endpoint_is_the_pages_own_origin() {
        ...
        let injector = FiftyOneDegreesHeadInjector::new("https://publisher.example/api/v4/json");
